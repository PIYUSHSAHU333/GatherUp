    ...
    <div className="flex justify-center min-h-screen items-center">
      ...
      >
        ...
        <div class="title_container">
          ...
          {login ? (
            <span class="subtitle  text-xl">
              Login into your account and enjoy the experience or{" "}
              <span
                type="button"
            ...
            <span class="subtitle  text-xl">
              Create a new account and enjoy the experience or{" "}
              <span
                type="button"
                className="text-blue-500 cursor-pointer"
                onClick={() => {
